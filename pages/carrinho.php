...
<body>
  ...
  <main>
      ...
      <div class="container-master">
        ...
        <h1 style="text-align: center"><b>Bem Vindo ao Carrinho</b></h1>
        <h3 style="text-align: center">Exclua ou Conclua suas Compras.</h3>
    ...
    <?php foreach($data as $product):; ?> 
        <div id="caixa-items" class="caixa-update"><!--Caixa para os items-->
            <div class="items-container container-update">
              ...
              <a  href="productPage.php?pid=<?php echo $product['id']; ?>" class="flexboxteste">
      ...
      <?php endforeach; ?>
        ...
        <a id="fCart" href="https://youtu.be/dQw4w9WgXcQ">Concluir Compra.</a>
